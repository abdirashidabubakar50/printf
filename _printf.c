...
#define MAX_OUTPUT_LENGTH 1024 // Change this to the desired maximum output length
...
int _printf(const char *format, ...)
{
    ...
    {
        if (printed >= MAX_OUTPUT_LENGTH - 1) // Check if we exceed the maximum output length
            break;
